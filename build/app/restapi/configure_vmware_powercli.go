...
//go:generate swagger generate server --target ../../app --name VmwarePowercli --spec ../../../swagger.yaml --template-dir /Users/wilhelmwonigkeit/Documents/GitHub/direktiv-apps/vmware-powercli/build/templates --principal interface{}

func configureFlags(api *operations.VmwarePowercliAPI) {
...
func configureAPI(api *operations.VmwarePowercliAPI) http.Handler {
